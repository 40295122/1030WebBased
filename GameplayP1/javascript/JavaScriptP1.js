...
function wordPuzzle(){
    ...
    document.getElementById("narration").innerHTML = "[Narration]: Click guess to unjumble the word puzzle, but hurry! Time's running out! HINT: The first name begins with G and the last rhymes with bored! ";
